...
saxpyCuda(long total_elems, float alpha, float* xarray, float* yarray, float* resultarray, int partitions) {
    ...
    //
    cudaMalloc((void**)&device_x, sizeof(float)*total_elems);
    cudaMalloc((void**)&device_y, sizeof(float)*total_elems);
    cudaMalloc((void**)&device_result, sizeof(float)*total_elems);
    ...
    //
    cudaMemcpy(device_x, xarray, sizeof(float)*total_elems, cudaMemcpyHostToDevice);
    cudaMemcpy(device_y, yarray, sizeof(float)*total_elems, cudaMemcpyHostToDevice);
    ...
    //
    cudaMemcpy(resultarray, device_result, sizeof(float)*total_elems, cudaMemcpyDeviceToHost);
